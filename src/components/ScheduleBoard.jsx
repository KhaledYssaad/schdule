...
export default function ScheduleBoard() {
  ...
  const { data: schedule, isLoading } = useGetScheduleQuery(activeUser, {
    skip: !activeUser,
  });
    ...
    <div className="bg-slate-800 rounded-xl p-6 shadow-xl">
        ...
        {DAYS.map((day) => {
          ...
          return (
            <button
              ...
              disabled={isPast}
              className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap flex flex-col items-center grow ${
                activeDay === day
      ...
      <div className="space-y-6">
        <DayColumn
          ...
          isToday={false}
          onAddTask={
            currentUser === activeUser && !isPastDay(activeDay)
              ? openModal
              : null
          }
